...
\documentclass[a5paper, twoside, ngerman, 10pt]{scrbook}
...
\setkomafont{chapter}{\huge\color{porange}\fontspec{Politics Head}}
\setkomafont{section}{\LARGE\color{pgray}\fontspec{Politics Head}}
\setkomafont{subsection}{\Large\color{pgray}\fontspec{Politics Head}}
\setkomafont{subsubsection}{\large\color{pgray}\fontspec{Politics Head}}
